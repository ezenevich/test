...
namespace nevelly {
    ...
    public ref class MyClasses : public System::Windows::Forms::Form
    {
    public:
        MyClasses(void)
        {
    ...
    private:
        ...
        {
            System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(MyClasses::typeid));
            ...
            this->comboBoxClasses->SelectedIndexChanged += gcnew System::EventHandler(this, &MyClasses::comboBoxClasses_SelectedIndexChanged);
            // 
            // labelSelected
            // 
            ...
            this->buttonEnter->Click += gcnew System::EventHandler(this, &MyClasses::buttonEnter_Click);
            // 
            // label2
            // 
            ...
            this->Name = L"MyClasses";
            this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
            this->Text = L"Мои классы (Преподаватель)";
        ...
        void LoadClasses()
        {
            ...
            for each (String ^ file in classFiles)
            {
                try
                {
                    ...
                    if (lines->Length > 1 && lines[1] == currentUser)
                    {
        ...
        System::Void buttonEnter_Click(System::Object^ sender, System::EventArgs^ e)
        {
            ...
            try
            {
                teachclass^ t2Form = gcnew teachclass();
                t2Form->Show();
                this->Hide();
            }
            catch (Exception^ ex)

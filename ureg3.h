...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->radioButton4->Text = L"ýìïàòèÿ";
			...
			this->radioButton3->Text = L"îòâåòñòâåííîñòü";
			...
			this->radioButton2->Text = L"÷óâñòâî þìîðà";
			...
			this->radioButton1->Text = L"÷åñòíîñòü";
			...
			this->label4->Text = L"íàèáîëåå âàæíà â íàïàðíèêå\?";
			// 
			// label3
			// 
			...
			this->label3->Text = L"Êàêàÿ ÷åðòà õàðàêòåðà äëÿ âàñ ";
			// 
			// label2
			// 
			...
			this->label2->Text = L"Âàøè ïðåäïî÷òåíèÿ â íàïàðíèêå\?";
			// 
			// label1
			// 
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		if (lastUsername == "") {
			MessageBox::Show("Íåò çàðåãèñòðèðîâàííûõ ïîëüçîâàòåëåé");
			return;
		}
		...
		MessageBox::Show("Îøèáêà ïðè çàïèñè â ôàéë: " + ex->Message);
	}
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		if (!isSelected) {
			MessageBox::Show("Ïîæàëóéñòà, âûáåðèòå îäèí âàðèàíò");
			return;
		}
		if (count > 0) {
			selectedTraits += ",";
		...
		count++;
		if (count == 1) {
			label3->Text = "Êàêîé ñòèëü îáùåíèÿ";
	catch (Exception^ ex) {
                  MessageBox::Show(ex->Message);
			radioButton2->Text = "äðóæåëþáíîñòü è ïîääåðæêà";
			radioButton3->Text = "ôîðìàëüíîñòü è ïðîôåññèîíàëèçì";
			radioButton4->Text = "òâîð÷åñòâî è íåñòàíäàðòíîñòü";
		}
		else if (count == 2) {
			label3->Text = "Êàêîé ïîäõîä â ðåøåíèè";
			label4->Text = "ïðîáëåì âû ïðåäïî÷èòàåòå â íàïàðíèêå";
			radioButton1->Text = "àíàëèòè÷åñêèé è ëîãè÷íûé";
			radioButton2->Text = "êðåàòèâíûé è íåñòàíäàðòíûé";
			radioButton3->Text = "ïðàêòè÷íûé è áûñòðûé";
			radioButton4->Text = "êîìàíäíûé è ñîãëàñîâàííûé";
		}
		else if (count == 3) {
			label3->Text = "êàêóþ ðîëü";
			label4->Text = "äîëæåí âûïîëíÿòü íàïàðíèê â êîìàíäå";
			radioButton1->Text = "ëèäåð";
			radioButton2->Text = "èñïîëíèòåëü";
			radioButton3->Text = "ìîòèâàòîð";
			radioButton4->Text = "èäåîëîã";

...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label4->Text = L"ÿ ïðåïîäàâàòåëü";
			...
			this->button1->Text = L"ïðîäîëæèòü";
			...
			this->textBox5->Text = L"ïîâòîð ïàðîëÿ";
			...
			this->checkBox1->Text = L"ïîêàçàòü ïàðîëü";
			...
			this->label3->Text = L"ðåãèñòðàöèÿ";
...
private:
	System::Void button1_Click(System::Object^ sender, System::EventArgs^ e)
	{
		if (lb2)
		{
			if (textBox3->Text == "ÔÈÎ" || textBox4->Text == "ïàðîëü")
			{
				MessageBox::Show("Çàïîëíèòå âñå ïîëÿ!", "Îøèáêà", MessageBoxButtons::OK, MessageBoxIcon::Warning);
				return;
			}
			...
			try
			{
				...
				{
					MessageBox::Show("Ïîëüçîâàòåëü íå íàéäåí", "Îøèáêà", MessageBoxButtons::OK, MessageBoxIcon::Error);
					return;
				}
				...
				{
					MessageBox::Show("Îøèáêà äàííûõ ïîëüçîâàòåëÿ", "Îøèáêà", MessageBoxButtons::OK, MessageBoxIcon::Error);
					return;
				}
				...
				{
					MessageBox::Show("Íåâåðíûé ïàðîëü", "Îøèáêà", MessageBoxButtons::OK, MessageBoxIcon::Error);
					return;
				}
				...
				MessageBox::Show("Âõîä âûïîëíåí óñïåøíî!", "Óñïåõ", MessageBoxButtons::OK, MessageBoxIcon::Information);
			...
			{
				MessageBox::Show("Îøèáêà âõîäà: " + ex->Message, "Îøèáêà", MessageBoxButtons::OK, MessageBoxIcon::Error);
			}
		}
		else if (lb3) 
		{
			if (textBox3->Text == "ÔÈÎ" || textBox4->Text == "ïàðîëü(íå ìåíåå 6 ñèìâîëîâ)" || textBox5->Text == "ïîâòîð ïàðîëÿ")
			{
				MessageBox::Show("Çàïîëíèòå âñå ïîëÿ!", "Îøèáêà", MessageBoxButtons::OK, MessageBoxIcon::Warning);
				return;
			}
			...
			try
			{
				...
				{
					MessageBox::Show("ÔÈÎ äîëæíî ñîñòîÿòü èç òðåõ ñëîâ (Ôàìèëèÿ Èìÿ Îò÷åñòâî)", "Îøèáêà", MessageBoxButtons::OK, MessageBoxIcon::Warning);
					return;
				}
				...
				for each(Char c in fio)
				{
					...
					{
						MessageBox::Show("ÔÈÎ ìîæåò ñîäåðæàòü òîëüêî áóêâû, ïðîáåëû è äåôèñû", "Îøèáêà", MessageBoxButtons::OK, MessageBoxIcon::Warning);
						return;
					}
				}
				...
				{
					MessageBox::Show("Ïàðîëü äîëæåí ñîäåðæàòü ìèíèìóì 6 ñèìâîëîâ", "Îøèáêà", MessageBoxButtons::OK, MessageBoxIcon::Warning);
					return;
				}

				if (password != textBox5->Text)
				{
					MessageBox::Show("Ïàðîëè íå ñîâïàäàþò", "Îøèáêà", MessageBoxButtons::OK, MessageBoxIcon::Warning);
					return;
				}
				...
				if (File::Exists(userFile))
				{
					MessageBox::Show("Ïîëüçîâàòåëü ñ òàêèì ÔÈÎ óæå çàðåãèñòðèðîâàí", "Îøèáêà", MessageBoxButtons::OK, MessageBoxIcon::Warning);
					return;
				}
			...
			{
				MessageBox::Show("Îøèáêà ðåãèñòðàöèè ");
			}
		}
	}
...
private: System::Void label3_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	textBox4->Text = "ïàðîëü(íå ìåíåå 6 ñèìâîëîâ)";
	textBox4->PasswordChar = '\0';
	textBox5->Text = "ïîâòîð ïàðîëÿ";
	textBox5->PasswordChar = '\0';
	checkBox1->Checked = false;
}

private: System::Void textBox4_Click(System::Object^ sender, System::EventArgs^ e) {
	if (lb2 && textBox4->Text == "ïàðîëü") {
		textBox4->Text = "";
		textBox4->PasswordChar = '*';
	}
	else if (lb3 && textBox4->Text == "ïàðîëü(íå ìåíåå 6 ñèìâîëîâ)") {
		textBox4->Text = "";
		textBox4->PasswordChar = '*';
	}
}
...
private: System::Void textBox5_Click(System::Object^ sender, System::EventArgs^ e) {
	if (textBox5->Text == "ïîâòîð ïàðîëÿ") {
		textBox5->Clear();
	}
}
...
private: System::Void textBox5_TextChanged(System::Object^ sender, System::EventArgs^ e) {
	if (lb3) {
		if (textBox5->Text == "ïîâòîð ïàðîëÿ" || checkBox1->Checked) {
			textBox5->PasswordChar = '\0';
		}
		else {
...
private: System::Void textBox4_TextChanged(System::Object^ sender, System::EventArgs^ e) {
	if (lb2) {
		if (textBox4->Text == "ïàðîëü" || checkBox1->Checked) {
			textBox4->PasswordChar = '\0';
		}
		else {
			textBox4->PasswordChar = '*';
		...
		if (textBox4->Text == "ïàðîëü(íå ìåíåå 6 ñèìâîëîâ)" || checkBox1->Checked) {
			textBox4->PasswordChar = '\0';
		}
		else {
			textBox4->PasswordChar = '*';
...
private: System::Void checkBox1_CheckedChanged(System::Object^ sender, System::EventArgs^ e) {
	if (checkBox1->Checked) {
		...
		if (lb3 && textBox5->Text != "ïîâòîð ïàðîëÿ") {
			textBox5->PasswordChar = '\0';
		}
	}
	else {
